    ...
    return (
        <section id="textAboutMe">
            <div className="container aboutMeWrapper">
                ...
                <p>I've worn many hats in the past and now I'm wearing one saying: Junior Frontend Developer. I've started in boot camp in January 2022, learning the basics of <span>HTML</span>, <span>CSS</span> and <span>Javascript</span>.
